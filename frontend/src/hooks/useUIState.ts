...
const DEFAULT_LAYOUT: LayoutState = {
  components: {
    ...
    riseFallPanel: { visible: true, size: 'medium', order: 1 },
    higherLowerPanel: { visible: false, size: 'medium', order: 2 },
    positions: { visible: true, size: 'medium', order: 3 },
    watchlist: { visible: true, size: 'small', order: 4 },
    marketOverview: { visible: false, size: 'small', order: 5 },
    news: { visible: false, size: 'small', order: 6 },
    portfolio: { visible: true, size: 'small', order: 7 },
    clock: { visible: true, size: 'small', order: 8 },
    calculator: { visible: false, size: 'small', order: 9 },
  },
  theme: 'dark',
  language: 'en',
  accentColor: '#FF444F',
